...
| 21 | Resolve the default language from the video's original language — the `.4` audio-track id (BUG-013 fix; land before task 20) | [ ] DRAFT — DoD + Test Plan not approved | [docs/tasks/21-original-language-resolution/TASK.md](tasks/21-original-language-resolution/TASK.md) |
...
4. **Phase 2 (tasks 11-15), task 16 (observability logging), task 17
   ...
   **task 21 (DRAFT, awaiting approval)**. Task 20 is a DRAFT that should follow it.
