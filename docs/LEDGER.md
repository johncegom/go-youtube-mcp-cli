...
| 20 | Guarded, peek-only orig-first transcript fetch (BUG-012 follow-up; land task 21 first) | [ ] approved 2026-09-27 (rev 3), not started | [docs/tasks/20-guarded-orig-first/TASK.md](tasks/20-guarded-orig-first/TASK.md) |
...
4. **Phase 2 (tasks 11-15), task 16 (observability logging), task 17
   ...
   **task 21 (done, PR #38 merged 2026-09-27)**. Task 20 is approved, not started (rev 3: Program design now built on task 21's `captionInfo`/`resolveFromCaptions`; 20.0b promoted to a gate) approved by the human 2026-09-27; start with 20.0b.
