...
4. **Phase 2 (tasks 11-15), task 16 (observability logging), task 17
   ...
   **task 21 (done, PR #38 merged 2026-09-27)**. Task 20 is a DRAFT (rev 3: Program design now built on task 21's `captionInfo`/`resolveFromCaptions`; 20.0b promoted to a gate) awaiting human re-approval.
